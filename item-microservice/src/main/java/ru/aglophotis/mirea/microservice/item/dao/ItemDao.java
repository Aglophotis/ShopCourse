package ru.aglophotis.mirea.microservice.item.dao;

import org.hibernate.Session;
import org.hibernate.Transaction;
import ru.aglophotis.mirea.microservice.item.data.DatabaseContract;
import ru.aglophotis.mirea.microservice.item.entities.Item;
import ru.aglophotis.mirea.microservice.item.utils.HibernateSessionFactoryUtil;
